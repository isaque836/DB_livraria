-- Database: aula05-db-livraria
-- DROP DATABASE IF EXISTS "aula05-db-livraria";
/*
...
constraint fk_id_ite foreign key (id_ite) references item_pedido (id_ite)
);

create table livro_falta
...
constraint fk_id_livf foreign key (id_livf) references livro_falta (id_livf),
